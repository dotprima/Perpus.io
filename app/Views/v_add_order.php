            ...
            <div class="col-sm-12 col-xl-6">
                <div class="row">
                                ...
                                <form class="theme-form">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="exampleInputEmail1" type="email"
                                            ...
                                            class="form-text text-muted" id="emailHelp">We'll never share your email
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Horizontal Form Layout</h5><span>Using the <a href="#">card</a> component, you can
                                    extend the default collapse behavior to create an accordion.</span>
                            </div>
                            <div class="card-body">
                                <form class="theme-form">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label" for="inputPassword3">Contact
                                            Number</label>
                                        <div class="col-sm-9">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Inline Form</h5><span>Use<code>.form-inline</code>class in the form to style with
                                    inline fields.</span>
                            </div>
                            <div class="card-body">
